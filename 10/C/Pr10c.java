...
public class Pr10c extends Frame implements ActionListener {
    Frame f = new Frame();
    Label l1 = new Label("Roll Number: ", Label.CENTER);
    Label l2 = new Label("Student Name: ", Label.CENTER);
    Label l3 = new Label("CJ ", Label.CENTER);
    Label l4 = new Label("ES ", Label.CENTER);
    Label l5 = new Label("COST ", Label.CENTER);
    Label l6 = new Label("SE ", Label.CENTER);
